...
<div class="two-col" style="margin-bottom: 1.618em; overflow: hidden;">
	<div class="col">
		<h1 style="margin-right: 0;"><?php echo '<strong>Archetype</strong> <sup style="font-weight: bold; font-size: 33.333%; padding: 5px 10px; color: #666; background: #fff; white-space: nowrap;">' . esc_attr( $archetype_version ) . '</sup>'; ?></h1>
