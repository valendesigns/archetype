...
<div id="who" class="feature-section three-col" style="margin-bottom: 1.618em; padding-top: 1.618em; overflow: hidden;">
	<div class="col">
		<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/welcome-screen/img/valen.png'; ?>" alt="<?php esc_html_e( 'The Valen Team', 'archetype' ); ?>" class="image-50" width="440" />
		<h4><?php esc_html_e( 'Who is Valen?', 'archetype' ); ?></h4>
		<p><?php esc_html_e( 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'archetype' ); ?></p>
		<p><a href="http://valen.co" class="button"><?php esc_html_e( 'Come Visit Us', 'archetype' ); ?></a></p>
	</div>
	...
	<div class="col">
		...
		<p>
			<a href="http://github.com/valendesigns/archetype/" class="button"><?php esc_html_e( 'Archetype at GitHub', 'archetype' ); ?></a>
