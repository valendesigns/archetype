...
class Site_Logo {
	...
	public function preview_enqueue() {
		wp_enqueue_script( 'site-logo-preview', get_template_directory_uri() . '/inc/third-party/site-logo/js/site-logo.js', array( 'media-views' ), '', true );
		...
		if ( ! current_theme_supports( 'custom-header' ) ) {
			...
			wp_enqueue_script( 'site-logo-header-text', get_template_directory_uri() . '/inc/third-party/site-logo/js/site-logo-header-text.js', array( 'media-views' ), '', true );
